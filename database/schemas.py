...
class Owl(db.Model):
  ...
  descriptions = db.relationship('OwlDescription', backref='owl', order_by='OwlDescription.idx')
  image = db.Column(db.String(100), nullable=False)
  image_web = db.Column(db.String(100))
  image_thumbnail = db.Column(db.String(100))
  ratings = db.relationship('Rating', backref='owl', cascade='delete')
...
class Reviewer(db.Model):
  ...
  ratings = db.relationship('Rating', backref='reviewer', cascade='delete')
